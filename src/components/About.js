            ...
            <div className="col-md">
              <div className="service p-4 bg-base rounded-6 shadow-effect">
                <p>
                  ...
                  have participated in coding competition(SIH). I’m a hardworking
          ...
          <div className="row m-0">
            <div className="col-md-4">
              <div className="service p-4 bg-base rounded-6 shadow-effect">
                ...
                <p>
                  ...
                  HTML, CSS and javascript to deliver exceptional customer experiences.
                </p>
            ...
            <div className="col-md-4">
              <div className="service p-4 bg-base rounded-6 shadow-effect">
                ...
                <p>
                  Backend developer with experience in Nodejs.
                </p>
                <a href="#" className="link-custom">
                  Read more
                </a>
